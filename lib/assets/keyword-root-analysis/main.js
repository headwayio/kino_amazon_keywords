...
<div class="bg-white px-4">
  <h3 class="text-xl text-slate-500">Root Keyword Word Identification</h3>
  <p class="text-slate-500 py-2">Extract root words from a collection of search terms.</p>
  <div class="flex flex-col space-y-4">
    ...
    <div class="form-control">
      <div class="form-control w-48">
        <label class="label">
          ...
          <input id="normalize" type="checkbox" class="checkbox checkbox-info" />
        </label>
      </div>
    </div>
    ...
    <div class="w-32 pt-4">
      <button id="submit" class="hidden btn btn-neutral">Submit</button>
    </div>
  </div>
</div>
  `;
